...
- [ ] **A4** Define deployment & release gates (determinism hash, fixture integrity verification script, `swift test` guard). _Depends on:_ A1. _Doc:_ PRD §Phase A. _Owner:_ docc2context agent. _Status:_ Newly selected – scope + next steps documented in `DOCS/INPROGRESS/A4_ReleaseGates.md`.
