...
- [ ] **B2** Implement argument parsing to satisfy CLI interface tests using `swift-argument-parser`. _Depends on:_ B1. _Doc:_ PRD §Phase B. _Owner:_ docc2context agent. _Status:_ In Progress – parser dependency added, CLI now delegates to `Docc2contextCLIOptions`, and ongoing notes live in `DOCS/INPROGRESS/B2_ArgumentParsing.md`.
