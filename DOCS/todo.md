...
- [ ] **B5** Parse DocC metadata (Info.plist, documentation data, symbol graphs) into native models with fixture-driven failure coverage. _Depends on:_ B3. _Doc:_ PRD §Phase B. _Owner:_ docc2context agent. _Status:_ In Progress – START ritual completed with [`DOCS/INPROGRESS/B5_DoccMetadataParsing.md`](./INPROGRESS/B5_DoccMetadataParsing.md); first failing spec underway: `MetadataParsingTests.test_infoPlistLoadsBundleMetadata`.
