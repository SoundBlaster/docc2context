...
- **Current Status:** D1–D3 are archived per the [workplan](../workplan.md); automation currently stops at `Scripts/release_gates.sh`, so there is no script that builds and upload-ready artifacts or records the release checklist.
