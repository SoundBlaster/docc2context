...
package() {{
  ...
  local build_dir="$srcdir/extracted/docc2context-v${{pkgver}}"
  install -Dm755 "$build_dir/docc2context" "$pkgdir/usr/local/bin/docc2context"
  install -Dm644 "$build_dir/README.md" "$pkgdir/usr/share/doc/docc2context/README.md"
  install -Dm644 "$build_dir/LICENSE" "$pkgdir/usr/share/doc/docc2context/LICENSE"
}}
"""
