...
5. **Test-Driven Development** – Follow the [XP-inspired outside-in workflow](DOCS/RULES/01_TDD.md): write failing tests first for CLI contracts, bundle handling, parsing, Markdown generation, and determinism checks. Use XCTest, snapshot fixtures, and deterministic hash comparisons per the PRD.
